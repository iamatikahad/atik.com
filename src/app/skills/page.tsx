...
const flutterSkills = [
    { name: "Flutter Framework", value: 95 },
    { name: "Dart", value: 90 },
            ...
            <div className="max-w-4xl mx-auto w-full flex-grow relative z-10">
                ...
                >
                    ...
                    <p className="text-xl text-zinc-400 max-w-2xl">
                        A breakdown of my technical proficiency in mobile development and digital design. I believe in mastering tools to build uncompromised experiences.
                    </p>
                </motion.div>
